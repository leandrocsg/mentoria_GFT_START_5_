package desafios;
/*Número Reverso:
Faça um programa que leia um valor inteiro (este número deverá conter 4 dígitos). A saída deverá ser o
...
b) Se o usuário digitar 3 dígitos ou menos, o Programa avisa que tem que conter 4 dígitos e continuar a
...
public class NumeroReverso {
	...
	do {
		...
		if(numeroInformado >= 1000 && numeroInformado <= 9999) {
			...
			System.out.println("O numero informado deverá conter 4 digitos!");
		}
	}while(true);
